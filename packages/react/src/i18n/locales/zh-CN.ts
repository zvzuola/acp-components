export const zhCN = {
  ...
  'agentsView.name': '名称',
  'agentsView.namePlaceholder': '智能体名称',
  'agentsView.transport': '传输方式',
  'agentsView.transportUrl': '地址',
  'agentsView.transportUrlPlaceholder': 'ws://127.0.0.1:3100',
  'agentsView.transportCommand': '命令',
  'agentsView.transportCommandPlaceholder': 'opencode',
  'agentsView.args': '参数',
  'agentsView.argsPlaceholder': 'acp',
  'agentsView.add': '添加智能体',
  'agentsView.adding': '添加中…',
  'agentsView.remove': '删除',
  'agentsView.removeAriaLabel': '删除智能体',
  'agentsView.builtin': '内置',
  'agentsView.statusConnected': '已连接',
  'agentsView.statusConnecting': '连接中…',
  'agentsView.statusDisconnected': '未连接',
  'agentsView.statusError': '错误',
  'agentsView.addError': '添加智能体失败',
  ...
  'newSession.noAgents': '尚未添加智能体。请前往“设置 > 智能体”添加后开始对话。',
  'newSession.addAgent': '添加智能体',
