export const enUS = {
  ...
  'agentsView.namePlaceholder': 'Agent name',
  'agentsView.transport': 'Transport',
  'agentsView.transportUrl': 'URL',
  'agentsView.transportUrlPlaceholder': 'ws://127.0.0.1:3100',
  'agentsView.transportCommand': 'Command',
  'agentsView.transportCommandPlaceholder': 'opencode',
  'agentsView.args': 'Arguments',
  'agentsView.argsPlaceholder': 'acp',
  'agentsView.add': 'Add agent',
  'agentsView.adding': 'Adding…',
  'agentsView.remove': 'Remove',
  'agentsView.removeAriaLabel': 'Remove agent',
  'agentsView.builtin': 'Built-in',
  'agentsView.statusConnected': 'Connected',
  'agentsView.statusConnecting': 'Connecting…',
  'agentsView.statusDisconnected': 'Disconnected',
  'agentsView.statusError': 'Error',
  'agentsView.addError': 'Failed to add agent',
  ...
  'newSession.noAgents': 'No agents configured. Add an agent in Settings to start a conversation.',
  'newSession.addAgent': 'Add agent',
